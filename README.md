...
## For compilation, type the following

`make`

## To run the program 

`./fat32 a4image command_to_execute`
...
`./fat32 a4image info` produced the following output:
...
--------------
Total size: 34816KB
The cluster size in number of sectors: 1
Usable space on the drive: 34264KB
The cluster size in number of sectors: 0.5KB
Free space on the drive: 27842KB
--------------
Program ended successfully
```

***
`./fat32 a4image list` produced the following output:

```
Root Directory: 3430A4
Directory Name: BOOKS
File: PANDP.TXT
File: WARAND~1.TXT
File: MOBYDICK.TXT
-Directory Name: FULLDIR
-File: 289.TXT
-File: 504.TXT
-File: 262.TXT
-File: 276.TXT
...
# Multiple test data was used to test the get command


`./fat32 a4image get folder1/folder2/folder3/theFile.txt` produced the following output

```
Started reading contents of the file
--------------
O HAI
...
***
`./fat32 a4image get books/PandP.txt` produced the following output
